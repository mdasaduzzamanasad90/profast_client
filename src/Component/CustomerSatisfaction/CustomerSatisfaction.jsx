...
const CustomerSatisfaction = () => {
  return (
    <div
      data-aos="zoom-in-up"
      className="bg_color md:mt-36 md:rounded-[80px] rounded-[40px] text-white flex flex-col md:flex-row items-center justify-between md:p-28 p-12 bg-cover bg-center"
      style={{
        backgroundImage: `url(${CustomerSatisfactionimg2})`,
    ...
    >
      <div className="text-white text-left flex flex-col justify-center">
        <h1
          data-aos="fade-up"
          data-aos-delay="1300"
          className="text-2xl sm:text-3xl md:text-4xl font-bold max-w-3xl leading-snug mb-6"
        >
        ...
        <p
          data-aos="fade-up"
          data-aos-delay="1300"
          className="text-sm sm:text-base md:text-lg text-gray-300 max-w-2xl mb-10"
        >
